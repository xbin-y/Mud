...
namespace Trady.Analysis.Extension
{
    public static class FuncExtension
    {
        ...
        public static FuncAnalyzable<TInput, decimal?> AsAnalyzable<TInput>(this Func<IReadOnlyList<TInput>, int, IReadOnlyList<decimal> ,IAnalyzeContext<TInput>, decimal?> func, IEnumerable<TInput> inputs, params decimal[] parameters) where TInput : IOhlcv => new FuncAnalyzable<TInput, decimal?>(inputs, parameters).Init(func);
    }
}
