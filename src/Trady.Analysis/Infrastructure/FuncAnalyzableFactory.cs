...
namespace Trady.Analysis.Infrastructure
{
    ...
    {
        public static IFuncAnalyzable<TOutput> CreateAnalyzable<TInput, TOutput>(string name, IEnumerable<TInput> inputs, params decimal[] parameters) where TInput : IOhlcv
        {
