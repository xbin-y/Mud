...
namespace Trady.Analysis.Infrastructure
{
    public static class FuncRegistry
    {
		...
		public class FuncGlobals<TInput> where TInput : IOhlcv
        {
        ...
        private static Func<IReadOnlyList<TInput>, int, IReadOnlyList<decimal>, IAnalyzeContext<TInput>, decimal?> CreateFunc<TInput>(string expression) where TInput : IOhlcv
        {
        ...
        public static bool Register<TInput>(string name, string expression, bool @override = false) where TInput : IOhlcv => _Register(name, CreateFunc<TInput>(expression), @override);

        public static bool Register<TInput>(string name, Expression<Func<IReadOnlyList<TInput>, int, IReadOnlyList<decimal>, IAnalyzeContext<TInput>, decimal?>> expr, bool @override = false) where TInput : IOhlcv => _Register(name, expr.Compile(), @override);
